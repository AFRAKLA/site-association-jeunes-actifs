...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
      ...
      <div>
        <label htmlFor="sujet" className="mb-2 block text-sm font-medium text-ink">
          {t("sujetLabel")}
        </label>
        <input
          type="text"
      ...
      {status === "error" && (
        <p className="admin-reveal rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-center text-sm font-medium text-red-700">
          {t("error")}
        </p>
      )}
    </form>
