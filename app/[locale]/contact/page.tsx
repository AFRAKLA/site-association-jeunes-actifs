      ...
      <main id="main-content">
        ...
        <section className="px-6 py-14 md:py-16">
          <div className="mx-auto grid max-w-4xl gap-x-12 gap-y-10 sm:grid-cols-2">
            <div>
              <p className="text-[11px] font-medium uppercase tracking-[0.14em] text-champagne">{t("coordonnees.kicker")}</p>
              <div className="mt-5 space-y-5 text-sm">
                <div className="flex gap-3">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-surface-muted ring-1 ring-champagne-soft">
                    <svg className="h-[18px] w-[18px] text-forest" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@jeunes-actifs.ma" className="mt-0.5 block text-forest hover:underline">
            ...
            <div>
              <p className="text-[11px] font-medium uppercase tracking-[0.14em] text-champagne">{t("reseaux.kicker")}</p>
              ...
              <div className="mt-5 flex flex-col gap-2.5">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 text-sm text-ink transition-colors duration-150 hover:text-forest"
                >
